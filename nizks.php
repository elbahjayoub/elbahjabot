<?php
//=========التوكن=========//
$token = "7414888302:AAFqxX3Rm6757wjsVgbrNsZ9ErLO19gUjCg"; 
...
#############
$admin = "6282471972";
$Dev = array("$admin","6282471972");
$eri = array("$admin","6282471972");
$idbot = "7414888302";
$sudo = "$admin";
$buy = "elbahjaayoub";
$DevUser = "@$buy";
$devchink = "elbahjaay0ub";
$userbot = "groupayoubmanager1bot";
$chsource = "$devchink";
############
if ($tc == 'private'){  
@$user = json_decode(file_get_contents("data/user.json"),true);
...
⋄︙ [تحديثات السورس الجديده](https://t.me/elbahjaayoub)",
'parse_mode'=>"markdown",
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/elbahjaayoub"]],
]])
]); 
}
}
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/elbahjaayoub"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
